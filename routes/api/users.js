...
// Hash password before saving in database
      bcrypt.genSalt(10, (err, salt) => {
        bcrypt.hash(db.collection("CollectionTest").find({password :req.body.password}), salt, (err, hash) => {
          //if (err) throw err;
          db.collection("CollectionTest").find({password :req.body.password}) = hash;
